        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
            <ul className="text-lg text-center  sm:flex items-center  justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
              ...
              <li>
                <Link to="/skills" className="text-black hover:text-green-500">
                  Skills
                </Link>
              </li>
              <li className="sm:my-0 my-2">
            ...
            <div className="flex  space-x-4 sm:justify-center  ">
              ...
              >
                <svg
                  className="w-[1.25rem] h-[1.125rem] text-black"
                  viewBox="0 0 15 15"
                  fill="none"
              ...
              <Link
                to="https://www.linkedin.com/in/sunil-chand-709165288?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600"
              >
                <svg
          ...
          <div className="py-7 border-t border-gray-700">
            <div className="flex items-center justify-center">
              <span className="text-gray-400 ">
                ©<a href="/">sunil</a>2024, All rights reserved.
              </span>
            </div>
          </div>
        </div>
