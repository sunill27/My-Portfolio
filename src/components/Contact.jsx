...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    // Ensure formRef is current and has elements
    if (formRef.current) {
      emailjs
        .sendForm(
          "service_5wr3bho",
  ...
  return (
    <>
      <Navbar />
      <div className="max-w-screen-xxl p-5 bg-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-12 border">
          <div className="bg-gray-900 md:col-span-4 p-10 text-white">
            ...
            <p className="mt-4 leading-7 text-gray-200">
              ...
              innovative projects! Whether you’re looking to partner with, have
              a groundbreaking idea, I'm here to help.
            </p>
            <p className="mt-4 leading-7 text-gray-200">
              Feel free to reach out with your project proposals, collaboration
              ideas, or any inquiries. I am eager to discuss how we can work
              together to bring new visions to life.
            </p>
            ...
            <div className="flex items-center mt-5">
              <svg
                ...
                style={{ enableBackground: "new 0 0 489.536 489.536" }}
              >
                <g>
                  <g>
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
              ...
              <span className="text-sm m-1">+977 9848979552 </span>
            </div>
            <div className="flex items-center mt-5">
              <svg
                className="h-6 mr-2 text-indigo-600"
          ...
          <form
            ref={formRef}
            onSubmit={sendEmail}
            className="md:col-span-8 p-10 bg-white"
            id="contact-form"
          >
